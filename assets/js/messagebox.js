...
(function($, undefined){
    ...
    $.MessageBox = function(options){
        ...
        $(document.activeElement).not(".messagebox .form-control").trigger("blur");
    ...
    function _CreateInput(name, definition){
        ...
        switch (type) {
            case "selects":
                var select  = _FormatInput($("<select multiple>"), {
                    name        : name, 
    ...
    function _Window_KeyDown(event){
        ...
        if (button) {
            button.closest(".messagebox").find(".form-control").trigger("blur");
